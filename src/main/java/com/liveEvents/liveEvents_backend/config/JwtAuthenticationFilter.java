...
import com.liveEvents.liveEvents_backend.services.UserDetailServiceImp;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (token != null && tokenProvider.validateToken(token) && userDetails != null) {
            ...
            System.out.println("L'utilisateur authentifié: " + userDetails.getUsername());
        } else {
            System.out.println("Token n'est pas valid");
        }
